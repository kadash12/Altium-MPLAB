...
void main() {
    ...
    while(1){
        ...
        if(value1 == 0){
            ...
            value1 = ((value1+adcNum1())/2)+2;
        }


        V = (value0*volt*1000)/1023;
        temp = V/1000.0;
        ...
        if(PORTBbits.RB0==0 && PORTBbits.RB1==0){
            ...
            for (int x = 0; x < 50; x++){
                unsigned char volatile outv = (int)(sin[x]/(temp+0.05));
                spi_write(outv);
            ...
            for (int x = 0; x < 50; x++){
                unsigned char volatile outv = (int)(square[x]/(temp+0.05));
                spi_write(outv);
            }
        }
            ...
            for (int x = 0; x < 50; x++){
                unsigned char volatile outv = (int)(triangle[x]/(temp+0.05));
                spi_write(outv);
            }
        }
           ...
           for (int x = 0; x < 50; x++){
                unsigned char volatile outv = (int)(sawtooth[x]/(temp+0.05));
                spi_write(outv);
            }
        }
    }
